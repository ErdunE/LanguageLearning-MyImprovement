...
//        public static double random(): 返回值为double的政治，[0.0,1.0)
        System.out.println(Math.random());
        System.out.println(Math.random()*100);
        System.out.println("--------");

        System.out.println((int)(Math.random()*100)+1);// 1-100随机数
